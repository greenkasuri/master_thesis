...
load("../data/2016_MGP_broad.RData")
...
save(model, file="model_2016_broad_originalscreens.RData")
...
save(model, file="model_2016_broad_originalscreens_demeaned.RData")
...
save(model, file="model_2016_broad_originalscreens_standardized.RData")
...
save(model, file="model_2016_broad_MGPscreens.RData")
...
save(model, file="model_2016_broad_MGPscreens_demeaned.RData")
...
save(model, file="model_2016_broad_MGPscreens_standardized.RData")