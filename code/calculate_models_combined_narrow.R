...
save(model, file="model_combined_narrow_originalscreens.RData")
...
save(model, file="model_combined_narrow_originalscreens_demeaned.RData")
...
save(model, file="model_combined_narrow_originalscreens_standardized.RData")
...
save(model, file="model_combined_narrow_MGPscreens.RData")
...
save(model, file="model_combined_narrow_MGPscreens_demeaned.RData")
...
save(model, file="model_combined_narrow_MGPscreens_standardized.RData")